...
class OverviewPage(QWidget, Ui_OverviewPage):
    ...
    def update(self):
        ...
        # Condition to prevent for RPC errors
        if funds:
            # Note: ln balance is in mgro but Groestlcoin's one is in mgro
            ...
            self.labelBalanceLightning.setText(str(ln_balance_av) + "MGRO")
            self.labelPendingLightning.setText(str(ln_balance_pen) + "MGRO")
            self.labelLightningTotal.setText(str(ln_balance_av + ln_balance_pen) + "MGRO")
            ...
            self.labelBalanceBitcoin.setText(str(btc_balance_av) + "GRO")
            self.labelPendingBitcoin.setText(str(btc_balance_pen) + "GRO")
            self.labelBitcoinTotal.setText(str(btc_balance_av + btc_balance_pen) + "GRO")
