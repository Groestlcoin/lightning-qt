...
class Ui_ChannelsPage(object):
    ...
    def retranslateUi(self, ChannelsPage):
        ...
        self.label_6.setText(_translate("ChannelsPage", "MGRO"))
        ...
        self.label_9.setText(_translate("ChannelsPage", "GRO"))
        ...
        self.label_10.setText(_translate("ChannelsPage", "Incoming (mgro)"))
        self.label_8.setText(_translate("ChannelsPage", "Amount (mgro)"))
